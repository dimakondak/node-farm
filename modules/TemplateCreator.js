function TemplateCreator(slugsMap) {
    ...
    this.createProductCardTemplate = (cardTemplate, product) =>
        cardTemplate
            ...
            .replace(
                ...
                this.slugsMap
                    .entries()
                    .find(([, value]) => value === product?.id)[0]
            );
    this.createOverviewTemplate = (overviewTemplate, productCardTemplate) =>
        overviewTemplate.replace('{%PRODUCT_CARDS%}', productCardTemplate);
}
